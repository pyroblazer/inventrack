...
function createBaseUser(): User {
  return { $type: "api.users.User", id: "", email: "", role: 0 };
}
...
function createBaseTokenPayload(): TokenPayload {
  return { $type: "api.users.TokenPayload", userId: "", email: "", role: 0 };
}
...
function createBaseCredential(): Credential {
  return { $type: "api.users.Credential", id: "", name: "", userId: "" };
}
...
function createBaseDeleteCredentialRequest(): DeleteCredentialRequest {
  return { $type: "api.users.DeleteCredentialRequest", id: "" };
}
...
function createBaseRevealCredentialRequest(): RevealCredentialRequest {
  return { $type: "api.users.RevealCredentialRequest", id: "" };
}
